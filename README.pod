...
Searchs for bare filename, filename.pod and filename.pm, in both
the current directory and lib/.

Links to itself for C<LE<lt>E<gt>> links which reference module names.
